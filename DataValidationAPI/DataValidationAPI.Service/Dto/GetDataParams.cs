namespace DataValidationAPI.Service.Dto
{
    ...
    public class GetDataParams
    {
        ...
        /// </summary>
        public UserParam? UserParam { get; set; } = null;
    }
    ...
    /// <remarks>
    /// <para>
    /// email -  часть электронной почты, dateStart - начало 
    /// промежутка даты создания, dateEnd - конец промежутка даты создания
    /// </para>
    /// <para>
    /// Есть данные 4 типов. Не проверенные (isUnverifiedData), прошедшие проверку (isValidatedData), не прошедшие 
    ...
    /// </para>
    /// </remarks>
    public class GetDataCountParams
    {
        /// <summary>
        /// Параметры для получения данных
        /// </summary>
